...
export default async function AdminPage() {
  ...
  return (
    <div className="grid gap-6">
      <Card className="border-[#e4d3bf] bg-[linear-gradient(135deg,#f7efe6_0%,#efe3d7_100%)] shadow-[0_28px_60px_-44px_rgba(217,119,6,0.18)]">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {[
          ...
          <Card key={title} className="border-[#e1d5c8] bg-[linear-gradient(180deg,#faf6f1_0%,#f2ebe2_100%)]">
            <CardHeader>
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        <Card className="border-[#e1d6ca] bg-[linear-gradient(180deg,#faf6f1_0%,#f3ece4_100%)]">
          <CardHeader>
          ...
          <CardContent className="grid gap-3">
            {[
              ...
              <div key={title} className="rounded-[1.35rem] border border-[#e1d6ca] bg-[#f5eee6] p-4">
        ...
        <Card className="border-[#ddcfbf] bg-[linear-gradient(180deg,#eadfce_0%,#dfd1bf_100%)] text-slate-950">
          <CardHeader>
