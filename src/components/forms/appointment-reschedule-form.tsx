...
export function AppointmentRescheduleForm({
  ...
  return (
    <form action={formAction} className="grid gap-5 rounded-[1.6rem] border border-[#d8e5ef] bg-[#f8fbfe] p-5">
      ...
      <div className="flex items-center gap-2 rounded-full bg-white px-3 py-2 text-slate-700 shadow-[0_12px_24px_-24px_rgba(15,23,42,0.3)]">
        <CalendarDays className="size-4 text-[#0f9db1]" />
        <p className="font-medium">Перенести запис</p>
      </div>
      ...
      <div className="grid gap-3 md:grid-cols-2">
        <div className="flex flex-col gap-2">
          ...
          <select
            ...
            className="h-12 rounded-[1.1rem] border border-[#cfe0eb] bg-white px-4"
          >
            {doctors.map((doctor) => (
      ...
      <div className="grid gap-3 rounded-[1.4rem] border border-dashed border-[#cfe0eb] bg-white/80 p-4">
        ...
        <div className="grid gap-2 sm:grid-cols-3">
          {slots.map((slot) => (
            <button
              ...
              className={cn(
                "rounded-[1rem] border px-3 py-2 text-left text-sm transition-all",
      ...
      <div className="flex flex-col gap-2">
        ...
        <Textarea
          ...
          className="min-h-24 rounded-[1.1rem] border-[#cfe0eb] bg-white px-4 py-3"
        />
      </div>
      ...
      <Button
        ...
        className="h-12 rounded-full bg-[#63bac4] text-white hover:bg-[#4ea8b2]"
      >
